    ...
    <>
      <div className="paymentCardOuter">
        ...
        <div className="planCards">
          ...
          <div
            className="x"
            onClick={() => setCurrentPlan(179)}
            id={currentPlan === 179 ? "borderedPlan" : ""}
          >
            <PlanCard
              planData={{
                status: "Recommended",
          ...
          <div
            className="x"
            onClick={() => setCurrentPlan(149)}
            id={currentPlan === 149 ? "borderedPlan" : ""}
          >
            <PlanCard
              planData={{
                status: "Deluxe Pack",
          ...
          <div
            className="x"
            onClick={() => setCurrentPlan(99)}
            id={currentPlan === 99 ? "borderedPlan" : ""}
          >
            <PlanCard
              planData={{
                status: "Golden Pack",
        ...
        <div className="buttons">
          ...
          <div className="pay">Proceed to pay</div>
        </div>

  ...
  return (
    <div>
      <div className="descBody">
        ...
        <ul>
          <li>
            <img src={Image} alt="" /> <span>100+</span> Job relevant courses
          </li>
          <li>
            <img src={Image2} alt="" /> <span>20,000+</span> Hours of content
          </li>
          <li>
            <img src={Image3} alt="" /> <span>Exclusive</span> webinar access
          </li>
          <li>
            <img src={Image4} alt="" /> Scholarship worth{" "}
            <span>
              <BiRupee />
              94,500
            </span>
          ...
          <li>
            <img src={Image5} alt="" /> <span>Ad Free</span> learning experience
          </li>
        </ul>
      </div>
    </div>
